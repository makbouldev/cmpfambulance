export const fallbackData = {
  ...
  hero: {
    ...
    subtitle:
      'CMPF Nettoyage intervient pour maisons, bureaux, commerces, chantiers et sites professionnels avec des equipes fiables, du materiel adapte et un resultat propre jusque dans les details.',
  ...
  story: {
    ...
    content:
      'CMPF Nettoyage organise des interventions adaptees aux particuliers, entreprises, syndics, commerces et sites industriels. Nous preparons le planning, les produits, le materiel et le controle qualite afin de garantir un service propre, ponctuel et discret.',
    image: '1.jpeg'
  },
  fleet: [
    {
  ...
  testimonials: [
    ...
    },
    {
      ...
      text: 'CMPF Nettoyage garde nos locaux propres avec regularite, discretion et un vrai sens du detail.'
    },
    {
